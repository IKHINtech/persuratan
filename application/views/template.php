...
<head>
    ...
    <link rel="icon" type="image/png"  href="<?=base_url()?>assets/img/favicon.ico" type="image/gif"> 
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
    <meta content='width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0, shrink-to-fit=no' name='viewport' />
    <title>Sistem Persuratan Pelita Bangsa</title>
            ...
            <div class="sidebar-wrapper">
                <div class="logo">
                    <a href="<?= base_url() ?>" class="simple-text">
                        <img src="<?= base_url('assets/img/logo_perguruanTinggi_1.png') ?>" alt="" class="img-fluid">
                    </a>
                </div>
                <ul class="nav">
                    <li class="nav-item">
        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg " color-on-scroll="500">
                <div class=" container-fluid">
                    <a class="navbar-brand" href="#pablo"> Persuratan </a>
                ...
                <div class="container">
                    <nav>
                        <p class="copyright text-center">
                            &copy; 2019 <a href="https://pelitabangsa.ac.id">Pelita Bangsa</a>
                        </p>
                    </nav>
                </div>
            </footer>
